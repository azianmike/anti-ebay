...
urlpatterns = patterns('',
    ...
    url(r'^getUserBidsJSON/', 'bidJSON.views.getUserBidsJSON'),
    url(r'^deleteUserBidJSON/', 'bidJSON.views.deleteUserBidJSON'),
    ...
    url(r'^autobidJSON/', 'autobidJSON.views.autobidJSON'),
    url(r'^autoBid/', 'autoBid.views.index'),
    url(r'^viewBids/', 'viewBids.views.index'),
)
